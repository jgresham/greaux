...
const TOOLTIPS = {
  ...
  peMultiple:       'P/E multiple applied to modeled FY2029 net income.',
...
const sourceNotes = [
  ...
  'Net margin default of 36% matches FY2024 GAAP and assumes stable software/cloud mix through FY2029.',
  ...
  return (
    <div style={{ position: 'relative', width: '100%', height: type === 'earnings' ? 310 : 360 }}>
      <canvas ref={canvasRef} role="img"
        aria-label={`Stacked bar chart of Microsoft ${type} by segment FY2022 through FY2029`}>
        Microsoft {type} by segment, FY2022–FY2024 actual and FY2025–FY2029 projected.
      </canvas>
    </div>
  );
}
      ...
      <div style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', flexWrap: 'wrap', gap: 14 }}>
              <div>
                ...
                <p style={{ fontSize: 14, color: 'var(--text3)', fontFamily: 'var(--mono)', maxWidth: 720, lineHeight: 1.6 }}>
                  FY2022–FY2024 actuals · Projected FY2025–FY2029 · All figures in USD billions · Fiscal year ends June 30
                </p>
              </div>
        ...
        <main style={{ flex: 1, padding: '2rem 2.5rem', maxWidth: 1100, margin: '0 auto', width: '100%' }}>
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(180px, 1fr))', gap: 12, marginBottom: '1.5rem' }}>
            ...
            <MetricCard label="Cloud Share FY2029" value={`${fmt(projections.cloudShare2029, 0)}%`} sub="of FY2029 revenue"       accent={SEGMENT_COLORS.cloud} />
          ...
          <section style={{ background: `linear-gradient(135deg, var(--bg2) 0%, rgba(0,164,239,0.05) 100%)`, border: `1px solid rgba(0,164,239,0.28)`, borderRadius: 'var(--radius-lg)', padding: '1.6rem 2rem', marginBottom: '1.5rem', display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: 20 }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 6, fontSize: 12, fontFamily: 'var(--mono)', color: 'var(--text3)', textAlign: 'right' }}>
              ...
              <span>{fmt(projections.cloudShare2029, 0)}% of FY2029 revenue from Intelligent Cloud</span>
