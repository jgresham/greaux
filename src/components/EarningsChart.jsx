...
export default function EarningsChart({ projections }) {
  ...
  useEffect(() => {
    ...
    chartRef.current = new Chart(canvasRef.current, {
      ...
      data: {
        labels,
        datasets: [
          ...makeDatasets(autoEarnings,   SEGMENT_COLORS.auto,   SEGMENT_LABELS.auto,   HIST_COUNT),
  ...
  return (
    <div style={{ position: 'relative', width: '100%', height: 300 }}>
      <canvas
        ref={canvasRef}
        role="img"
        aria-label="Stacked bar chart of Tesla annual earnings by segment 2020 to 2029, with 2025-2029 projected"
      >
        Tesla earnings by segment, 2020–2029. Historical 2020–2024; projected 2025–2029.
      </canvas>
    </div>
  );
}
